...
var CourierNavbar = React.createClass({
  ...
  render: function() {
    return (
      ...
      <li><a onClick={this.props.changeView} value="mapview" href="#Map View">Map View</a></li>
      <li><a onClick={this.props.changeView} value="showalljobs" href="#Show All Jobs">Show All Jobs</a></li>
